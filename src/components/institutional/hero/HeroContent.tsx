export default function HeroContent() {
    return (
        <div className="flex flex-col justify-center border-b border-white/10 ">
            <span className="mb-6 text-base font-semibold uppercase tracking-[0.2em] text-doar-gold">
                DOAR FINANCIAL INFRASTRUCTURE
            </span>

            <h1 className="mb-8 max-w-2xl text-4xl font-bold leading-[1.05] tracking-[-0.04em] text-text-primary sm:text-5xl lg:text-6xl xl:text-6xl">
                Infraestructura{' '}
            ...
            <p className="max-w-[640px] text-lg leading-relaxed text-soft-gray">
