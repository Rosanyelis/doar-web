import { Database, Landmark, Network, RefreshCw, ShieldCheck } from 'lucide-react';
import type { LucideIcon } from 'lucide-react';
import { SEGREGATED_LAYER_CARDS } from '../../../../constants/institutional';
import { cn } from '../../../../lib/utils';

const CARD_ICONS: Record<(typeof SEGREGATED_LAYER_CARDS)[number]['id'], LucideIcon> = {
    ledger: Database,
...
export default function SegregatedLayerGrid() {
    return (
        <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
            {SEGREGATED_LAYER_CARDS.map(({ id, title, description }) => {
